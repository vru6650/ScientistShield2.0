...
export default {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Brand alias palette (keeps existing professional-blue intact)
        brand: {
          50: '#F0F7FF',
          100: '#E0EEFF',
          200: '#B8D4F7',
      ...
      backgroundImage: {
        ...
        'brand-radial': 'radial-gradient(1200px 600px at 50% -10%, rgba(58,138,223,0.14), transparent 60%), radial-gradient(1000px 400px at 90% 10%, rgba(53,184,168,0.12), transparent 60%)',
        'brand-radial-dark': 'radial-gradient(1200px 600px at 50% -10%, rgba(29,114,206,0.18), transparent 60%), radial-gradient(1000px 400px at 90% 10%, rgba(58,138,223,0.12), transparent 60%)',
      },
      boxShadow: {
