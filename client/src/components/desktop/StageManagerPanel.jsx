...
import StageSceneCard from './StageSceneCard.jsx';
...
export default function StageManagerPanel({
    ...
    const baseClass =
        variant === 'floating'
            ? 'pointer-events-auto flex w-full max-w-4xl flex-col gap-4 overflow-y-auto rounded-[32px] border border-white/45 bg-white/55 p-5 shadow-[0_48px_120px_-60px_rgba(15,23,42,0.45)] backdrop-blur-2xl dark:border-white/10 dark:bg-slate-900/55 max-h-[min(82vh,720px)]'
            : 'pointer-events-auto fixed left-6 top-[132px] z-[46] hidden xl:flex w-[21.5rem] flex-col gap-4 rounded-[32px] border border-white/40 bg-white/35 p-5 shadow-[0_42px_120px_-50px_rgba(15,23,42,0.35)] backdrop-blur-2xl dark:border-white/10 dark:bg-slate-900/40';
    const rootClassName = className ? `${baseClass} ${className}` : baseClass;
...
StageManagerPanel.propTypes = {
    variant: PropTypes.oneOf(['sidebar', 'floating']),
