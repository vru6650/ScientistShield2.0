            ...
            <Navbar fluid rounded className="bg-transparent dark:bg-transparent relative z-10">
              ...
              <div className="flex items-center gap-space-md md:order-2">
                ...
                {currentUser ? (
                    ...
                    <Link
                      to="/sign-in"
                      className={`inline-flex items-center justify-center rounded-full border px-4 py-2 text-sm font-medium text-slate-700 shadow-sm backdrop-blur transition hover:bg-white/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 ${
                        isScrolled
                          ? 'bg-white/80 border-white/50 dark:bg-slate-900/70 dark:border-white/10'
                          : 'bg-white/70 border-white/40 dark:bg-slate-900/60 dark:border-white/10'
                      } dark:text-slate-200 dark:hover:bg-slate-900/70`}
                    >
                      Sign in
                    </Link>
                )}
